    ...
    <form class="" @submit.prevent="upload">
        ...
        <div class="space-y-4">
            <div>
                ...
                <input pattern="^[a-zA-Z0-9_]*$" title="This field should contain only underscores and alphanumeric characters." v-model="datasetName" type="text" :name="'dataset-name'" :class="'focus:ring-blue-500 focus:border-blue-500 inline-block w-72 sm:text-sm border-gray-300 rounded-md w-96'" :placeholder="'The dataset name'" required>
            ...
            <div class="">
                ...
                <div :class="(this.dragStatus ? 'border-blue-400 ' : 'border-gray-300 ') + 'max-w-lg flex justify-center px-6 pt-5 pb-6 border-2 border-dashed rounded-md'" @drop="drop" @dragover="dragover" @dragleave="dragleave">
                ...
                <div class="my-2">
                    <h2 class="max-w-lg text-xs font-medium text-gray-500">{{label}}</h2>
                </div>
            </div>
        </div>
    </form>
